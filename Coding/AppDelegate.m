...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    HWCodingTabBarController* tab = [[HWCodingTabBarController alloc] init];
    self.window.rootViewController = tab;
    
    NSDictionary* params = @{@"account": @"15927164270",
                             @"password": @"10fee92eb737eaacf448cc5356d079851cc867c0",
                             @"remember_me": @"true"
                             };
